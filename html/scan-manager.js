const ScanManager = (target) => {
        ...
        function targetList(targetSpec) {
            const targetExp = targetSpec.split(",");
            let final = [];
            ...
            let checkScanDone = () => {
                if (messageReceived == portsArr.length) {
            ...
            return {
                ...
                run(address) {
                    ...
                    //index++;
                    workerList[0].postMessage(target);
                }
            }
        }
